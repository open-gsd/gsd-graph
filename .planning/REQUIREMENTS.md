...
- [x] **ANS-01**: Deterministic answer renders markdown with triple citations from pack only
- [x] **ANS-02**: Empty pack produces abstain (no fabricated relationships)
...
- [x] **DIFF-01**: Diff current graph vs snapshot / last-diff-base (± nodes & triples by id)
- [x] **REP-01**: Repair regenerates projection from v1 without inventing triples
...
- [x] **RPT-01**: Minimal GRAPH_REPORT.md writer
