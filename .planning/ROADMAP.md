...
- [ ] 02-01-PLAN.md — Fingerprints, discover, MD/text extract, corpus fixtures (EXT-01, EXT-03)
- [ ] 02-02-PLAN.md — JSON/JSONL field-map extract + extract router (EXT-02)
...
| 2. Build pipeline | 0/4 | Not started | - |
