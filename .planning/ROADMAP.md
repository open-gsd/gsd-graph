...
- [ ] 03-01-PLAN.md — Query IR (term/path/neighborhood/filter) + budget ranks (QRY-01, QRY-02)
- [ ] 03-02-PLAN.md — Maintain invalidateProvenance + M1–M5 + build({full:false}) fix (MNT-01)
...
| 3. Query, lifecycle & maintain | 0/4 | Not started | - |
