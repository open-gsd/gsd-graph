...
Plans:
- [ ] 01-01-PLAN.md — Package bootstrap: CJS+types identity, README, CI, reason codes (PKG-01, PKG-02)
- [ ] 01-02-PLAN.md — Schemas, general ontology pack, Ajv validators, policy matrix (ONT-01..03)
