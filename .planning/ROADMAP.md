...
- [x] 05-03-PLAN.md — CLI pack/answer + flip Phase 4 unregistered tests (D-06)
- [x] 05-04-PLAN.md — Golden G0/G1(+G2) + CHANGELOG 0.1.0 release gate (GOLD-01..03)
...
- [x] 06-01-PLAN.md — LLM providers (none|prompt|http), prompts, Ajv apply, citation honesty (LLM-01)
- [x] 06-02-PLAN.md — MCP stdio server + bin; read tools on; build/review-write off by default (MCP-01)
- [x] 06-03-PLAN.md — Minimal GRAPH_REPORT.md writer + CLI report (RPT-01)
- [x] 06-04-PLAN.md — Example research + engineering ontology packs (ONT-04)
...
- [x] 07-01-PLAN.md — Pure-TS LPA library + synthetic two-clique tests (COM-01 core)
- [x] 07-02-PLAN.md — loadGraphV1 + communities/ sidecars + deterministic theme reports
- [x] 07-03-PLAN.md — CLI communities detect|report + version 0.2.0 + CHANGELOG/README
...
| 7. Global themes 0.2 | 3/3 | In Progress|  |
